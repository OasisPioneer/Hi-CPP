...
|**构建系统（Build System）**|管理项目的编译与链接过程，避免手动编译的繁琐|Make、CMake|
...
sudo apt-get install gdb          # 安装调试器 GDB
...
- 推荐使用 **Ubuntu + CLion/VSCode** 的组合。
    
- 手动安装编译器工具链，能帮助你理解每个组件的作用。
    
- 成功运行 “Hello, World!” 就意味着你已经真正迈入 C++ 的世界。
